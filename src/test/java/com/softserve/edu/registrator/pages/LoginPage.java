...
public class LoginPage extends ATopPage {
	...
	public LoginPage(WebDriver driver) {
		...
		this.signin = driver.findElement(By.cssSelector(SIGNIN_CSS));
	...
	public WebElement getSignin() {
		return this.signin;
		//return driver.findElement(By.cssSelector(SIGNIN_CSS));
	}
	...
	public String getLoginInputText() {
		return getLoginInput().getAttribute(VALUE_ATTRIBUTE);
	}
	...
	public String getPasswordInputText() {
		return getPasswordInput().getAttribute(VALUE_ATTRIBUTE);
	}
